...
#[derive(Debug)]
pub struct SyncForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SyncForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SyncForge processing");
    
    let mut processor = SyncForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SyncForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SyncForgeProcessor::new(false);
